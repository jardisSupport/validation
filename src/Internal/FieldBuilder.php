...
{
    /**
     * @var array<array{class: class-string<ValueValidatorInterface>, options: array<mixed>}>
     */
     ...
     * @param array<mixed> $options Validator options
     * @return self
     */
    public function validates(string $validatorClass, array $options = []): self
    {
    ...
    /**
     * @internal
     * @return array<array{class: class-string<ValueValidatorInterface>, options: array<mixed>}>
     */
